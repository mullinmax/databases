...
class admin {
	...
	void salesReport(Connection conn) throws SQLException, IOException {
		String query = "SELECT SUM(P.PRICE), SUM(T.SALEPRICE), E.NAME FROM EMPLOYEE E, TRANSACTION T, (SELECT SUM(I.BULKPRICE) AS PRICE, M.TACOID FROM INGREDIENT I, MADEWITH M WHERE I.NAME = M.INGREDIENT GROUP BY M.TACOID) P WHERE P.TACOID = T.TACOID AND E.SSN = T.EMPID GROUP BY E.NAME, E.SSN";
